...
public class PessoaController {
	...
	@ApiOperation(value = "View a list of available Pessoas", response = Iterable.class)
	...
	@ApiOperation(value = "Add a Pessoa")
	@RequestMapping(value = "/add", method = RequestMethod.POST, produces = "application/json")
	public ResponseEntity<String> savePessoa(@RequestBody Pessoa Pessoa) {
